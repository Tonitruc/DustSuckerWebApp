...
namespace ServiceLayer.AdvertisementsServices.QueryObject
{
    public enum SortedBy : byte
    {
        ...
        [Display(Name = "CostDescending")] CostDescending,
    ...
    public static class AdvertisementSort
    {
            ...
            string? sortBy)
        {
            ...
            return sortedByEnum switch
            {
                ...
                SortedBy.Rating => query.OrderByDescending(ad 
                    => ad.Hoover.Reviews.Count == 0 ? 0 : ad.Hoover.Reviews.Select(r => r.Rating).Average()),
